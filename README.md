...
10. Что бы выйти из любого меню в предыдущее меню или введите - 0 (ноль) и нажмите Enter. Выход с главного меню выходит с приложения и разлогинивает пользователя.
